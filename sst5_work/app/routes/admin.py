...
def admin_new_category(request: Request, admin: dict = Depends(require_admin)):
    from app.main import templates
    settings = CMSService.get_settings()
    return templates.TemplateResponse(request=request, name="admin/category_form.html", context={
        "request": request,
        "admin": admin,
        "category": None,
        "settings": settings,
...
def admin_customer_detail(request: Request, customer_id: str, admin: dict = Depends(require_admin)):
    ...
    settings = CMSService.get_settings()
    return templates.TemplateResponse(request=request, name="admin/customer_detail.html", context={
        "request": request,
        "admin": admin,
        "customer": customer,
        "settings": settings
...
def admin_enquiries(
    ...
    settings = CMSService.get_settings()
    return templates.TemplateResponse(request=request, name="admin/enquiries.html", context={
        "request": request,
        "admin": admin,
        "enquiries": enquiries,
        "selected_status": status,
...
def admin_enquiry_detail(request: Request, enquiry_id: int, success: Optional[str] = None, admin: dict = Depends(require_admin)):
    ...
    settings = CMSService.get_settings()
    return templates.TemplateResponse(request=request, name="admin/enquiry_detail.html", context={
        "request": request,
        "admin": admin,
        "enquiry": enquiry,
        "settings": settings,
...
def admin_homepage_sections(request: Request, success: Optional[str] = None, admin: dict = Depends(require_admin)):
    ...
    settings = CMSService.get_settings()
    return templates.TemplateResponse(request=request, name="admin/homepage_cms.html", context={
        "request": request,
        "admin": admin,
        "sections": sections,
        "settings": settings,
...
def admin_social_links(request: Request, success: Optional[str] = None, admin: dict = Depends(require_admin)):
    ...
    settings = CMSService.get_settings()
    return templates.TemplateResponse(request=request, name="admin/social_links.html", context={
        "request": request,
        "admin": admin,
        "links": links,
        "settings": settings,
...
def admin_faqs(request: Request, success: Optional[str] = None, admin: dict = Depends(require_admin)):
    ...
    settings = CMSService.get_settings()
    return templates.TemplateResponse(request=request, name="admin/faqs.html", context={
        "request": request,
        "admin": admin,
        "faqs": faqs,
        "settings": settings,
...
def admin_exports_page(request: Request, admin: dict = Depends(require_admin)):
    ...
    return templates.TemplateResponse(request=request, name="admin/exports.html", context={
        "request": request,
        "admin": admin,
        "settings": settings,
